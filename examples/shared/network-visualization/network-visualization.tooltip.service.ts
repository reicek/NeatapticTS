...
export interface NetworkVisualizationCanvasPointLike {
  xPx: number;
  yPx: number;
}
 ...
 * ```
 */
export function resolveNetworkVisualizationTooltipScene(
...
function createInputTooltipScene(
  hoveredInputDescriptionScene: NetworkVisualizationPositionedScene['inputDescriptionScenes'][number],
  positionedNodes: NetworkVisualizationPositionedScene['positionedNodes'],
  nodeWidthPx: number,
): NetworkVisualizationTooltipScene {
