...
const ENEMY_BOLT_PULSE_PERIOD_MS = 200;

/**
 * Animation states stored in the generated runtime atlas, in the same order as
 * `generate-enemy-sprites.ts` blits them.
 */
const ENEMY_SPRITE_STATES: EnemyAnimationState[] = [
  'idle',
  'move',
  'fire',
  'death',
...
const ENEMY_SPRITE_DIRECTIONS = 8;
 ...
 */
function resolveFramebufferDimensions(
 ...
 */
function resolveEnemyAnimationFrame(
  billboard: NeatensteinEnemyBillboard,
