...
import { NEATENSTEIN_ENEMY_COLLISION_RADIUS_CELLS } from '../browser-entry/host/game/constants';
...
/** Compass label for the north direction (yaw index 0). */
export const DIR_N = 'N';

/** Compass label for the north-west direction (yaw index 1). */
export const DIR_NW = 'NW';

/** Compass label for the west direction (yaw index 2). */
export const DIR_W = 'W';

/** Compass label for the south-west direction (yaw index 3). */
export const DIR_SW = 'SW';

/** Compass label for the south direction (yaw index 4). */
export const DIR_S = 'S';

/** Compass label for the south-east direction (yaw index 5). */
export const DIR_SE = 'SE';

/** Compass label for the east direction (yaw index 6). */
export const DIR_E = 'E';

/** Compass label for the north-east direction (yaw index 7). */
