...
Outputs:
  - examples/neatenstein/robot-sprite-data.js      (ES module with palette + frames)
  - examples/neatenstein/robot-sprite-data.json    (JSON verification copy)
  - examples/neatenstein/robot-proposal-192-<dir>-<pose>.png  (192x192 reference PNGs)
...
def main():
    base_dir = 'plans'
    output_dir = 'examples/neatenstein'
    ...
    # JS module
    js_path = os.path.join(output_dir, 'robot-sprite-data.js')
    with open(js_path, 'w') as f:
        f.write('// Auto-generated by examples/neatenstein/generate-robot-sprites.py\n')
        f.write('// Output: examples/neatenstein/robot-sprite-data.js\n')
    ...
    # JSON copy
    json_path = os.path.join(output_dir, 'robot-sprite-data.json')
