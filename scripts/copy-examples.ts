...
/** Prefix comment injected into generated docs/example pages. */
const GENERATED_EXAMPLE_PAGE_COMMENT_PREFIX =
...
/**
 * Prepends a generated-file warning to published example pages.
 *
 * @param exampleDefinition - Example publishing definition.
 * @param examplePageHtml - Final HTML that will be written into docs/examples.
 * @returns HTML prefixed with a warning that points readers back to the source file.
 */
function addGeneratedExamplePageComment(
  exampleDefinition: ExampleDefinition,
