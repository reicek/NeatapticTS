 ...
 * TURSO_SYNC_URL=libsql://... node scripts/semantic-index/perf-benchmark.mjs --json
 */
...
Usage:
  node scripts/semantic-index/perf-benchmark.mjs [options]

Options:
  --database <path|url>  Override the local database path (default: data/turso-replica.sqlite).
