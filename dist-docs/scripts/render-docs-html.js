...
async function main() {
    const readmes = await (0, fast_glob_1.default)(['**/README.md'], { cwd: DOCS_DIR, absolute: true });
    const pages = [];
    for (const mdFile of readmes) {
        const md = await fs_extra_1.default.readFile(mdFile, 'utf8');
    ...
    for (const meta of pages) {
        const md = await fs_extra_1.default.readFile(meta.abs, 'utf8');
        ...
        await fs_extra_1.default.writeFile(outFile, page, 'utf8');
    }
