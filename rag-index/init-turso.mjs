 ...
 *   `file:rag-index/data/turso-replica.sqlite` for local development. Use a `libsql://`
 *   URL for Turso Cloud.
 ...
 * node rag-index/init-turso.mjs --json
 *
 * // Turso Cloud
 ...
 */
const DEFAULT_SCHEMA_PATH = 'rag-index/schema-turso.sql';
 ...
 *
 * Usage:
 *   node rag-index/init-turso.mjs [--json] [--schema <path>] [--skip-diskann]
 */
async function main() {
