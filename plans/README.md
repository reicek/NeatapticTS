...
- NGE racing curriculum, racing readiness, UI-first racing, Tier 1–6 ladder, racing promotion rules, carry-state reset-state, racing reference design: `plans/NEAT_Genesis_EvoDevo_Racing_Curriculum.plans.md` (`plans\NEAT_Genesis_EvoDevo_Racing_Curriculum.plans.md`)
