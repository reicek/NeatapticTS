...
NeatapticTS already has a strong NEAT *controller* layer in [src/neat/](../../../neat/) (speciation, fitness sharing, mutation helpers, RNG/telemetry, export/import of innovation tables).
