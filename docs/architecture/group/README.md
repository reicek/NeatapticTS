...
Parameters:
- `connections` - The connections to extract unique source nodes from.
...
Parameters:
- `source` - The source group to connect from.
- `target` - The target group to connect to.
- `method` - The connection method (ALL_TO_ALL or ALL_TO_ELSE).
- `weight` - Optional fixed weight to apply to each new connection.
...
Parameters:
- `source` - The source group to connect from.
- `target` - The target layer to connect to.
- `method` - Optional connection method override.
- `weight` - Optional fixed weight to apply to each new connection.
...
Parameters:
- `source` - The source group whose nodes will each connect to the target.
- `target` - The single target node to connect every source node to.
- `weight` - Optional fixed weight to apply to each new connection.
...
Parameters:
- `source` - The source group whose nodes are disconnected.
- `target` - The target group whose nodes are disconnected from.
...
Parameters:
- `source` - The source group whose nodes are disconnected.
- `target` - The single target node to disconnect from.
- `twosided` - Whether to remove reciprocal connections as well.
...
Parameters:
- `group` - The group whose nodes act as gaters.
- `gatedConnections` - The connections to gate.
...
- `group` - The group whose nodes act as gaters.
- `gatedConnections` - The connections to gate.
- `sourceNodes` - The unique source nodes whose outbound connections are gated.
...
- `group` - The group whose nodes act as gaters.
- `gatedConnections` - The connections to gate.
- `sourceNodes` - The unique source nodes whose self-connections are gated.
...
Parameters:
- `connectionList` - The inbound connection list to search and mutate.
- `from` - The source node of the connection to remove.
- `to` - The target node of the connection to remove.
...
Parameters:
- `connectionList` - The outbound connection list to search and mutate.
- `from` - The source node of the connection to remove.
- `to` - The target node of the connection to remove.
...
Parameters:
- `source` - The source group whose connection method is being resolved.
- `target` - The target group to connect to.
