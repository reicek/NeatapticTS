...
function resolveRepresentativeNeuronInternal(
  ...
  return context.currentLayerNodes[representativeNeuronIndex] as NodeInternals;
}
...
function collectConvWeightValues(
  ...
  return representativeNeuronInternals.flatMap((representativeNeuronInternal) =>
 ...
 * @param convInputName Conv input tensor name.
 * @returns Nothing.
 */
