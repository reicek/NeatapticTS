...
Re-exports the owner-local helpers that score module focus, plan dry-run growth
morphs, schedule perturbation probes, and prune juvenile structure. The
top-level lifecycle runner in `src/neat/neat.nge-lifecycle.ts` consumes this
...
## neat/nge-juvenile/neat.nge-juvenile.ts
