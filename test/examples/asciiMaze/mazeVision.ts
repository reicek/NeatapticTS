...
export class MazeVision {
  ...
  static getEnhancedVision(
     ...
     * @returns True if the coordinates match the exit position.
     */
    ...
    /**
     * Scans in a given direction using DFS to determine openness and proximity to exit.
     * @param dx - X direction delta.
     * @param dy - Y direction delta.
     * @returns A value representing openness or proximity to exit in that direction.
     */
