...
function analizeWinner(
  ...
  console.log(
    'Test output for [0.25,0,1,0,0]:',
    winner.activate([0.25, 0, 1, 0, 0])
  );
  console.log(
    'Test output for [0.5,0,0,1,0]:',
    winner.activate([0.5, 0, 0, 1, 0])
  );
  console.log(
    'Test output for [0.75,0,0,0,1]:',
    winner.activate([0.75, 0, 0, 0, 1])
  );
