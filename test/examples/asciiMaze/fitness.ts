...
// Exports: evaluateNetworkFitness, defaultFitnessEvaluator

import { Network } from '../../../src/neataptic';
import { bfsDistance } from './mazeUtils';
 ...
 */
export function evaluateNetworkFitness(
  network: Network,
  encodedMaze: number[][],
  ...
  // Simulate the agent's run through the maze
 ...
 * @returns The computed fitness score for the network.
 */
export function defaultFitnessEvaluator(network: Network, context: IFitnessEvaluationContext): number {
