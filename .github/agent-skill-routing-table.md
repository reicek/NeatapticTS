...
<!-- source-hash: 34b175abba93e7d0bd66190a9bbde4ac4727803373b5a099d2c3184555bac9e8 -->
<!-- source-file-count: 112 -->
...
| --- | --- | --- | --- | --- |
| 00-helping | 1 | qwen3.5:cloud | helping-gap-resolution-coordinator<br>helping-agent-maintenance-coordinator<br>skill-inventory-auditor<br>agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>model-name-auditor<br>skill-trigger-eval-designer<br>skill-output-eval-grader<br>coverage-guard<br>learning-event-capturer<br>file-change-summarizer | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>subagent-delegation-patterns |
| 01-planning | 1 | qwen3.5:cloud | planning-context-coordinator<br>planning-risk-coordinator<br>planning-test-strategy-coordinator<br>acceptance-criteria-writer<br>plan-scout<br>model-name-auditor<br>plan-registration-auditor<br>helping-gap-resolution-coordinator | plan-alignment<br>tracker-handoff<br>phase-handoff-workflow<br>agent-frontmatter-standards<br>model-routing-and-budget<br>license-attribution-audit |
| 02-researching | 1 | qwen3.5:cloud | research-codebase-coordinator<br>plan-scout<br>docs-scout<br>repo-cortex-scout<br>boundary-mapper<br>skill-inventory-auditor<br>helping-gap-resolution-coordinator | subagent-delegation-patterns |
| 03-red-testing | 1 | qwen3.5:cloud | planning-test-strategy-coordinator<br>acceptance-criteria-writer<br>unit-test-writer<br>coverage-scout<br>determinism-scout<br>plan-scout<br>helping-gap-resolution-coordinator | red-test-contracts<br>test-fix-workflow<br>coverage-tranche |
| 04-implementing | 1 | qwen3.5:cloud | implementation-pattern-coordinator<br>boundary-mapper<br>docs-scout<br>browser-runtime-scout<br>worker-payload-scout<br>evaluation-pool-scout<br>checkpoint-scout<br>hybrid-interop-scout<br>determinism-scout<br>visualizer-scout<br>nge-core-scout<br>nge-benchmark-scout<br>neatchat-scout<br>solid-split<br>flappy-architecture-polish<br>agent-frontmatter-auditor<br>phase-handoff-designer<br>mcp-server-architect<br>helping-gap-resolution-coordinator | - |
| 05-green-testing | 1 | qwen3.5:cloud | green-test-failure-triage-coordinator<br>coverage-guard<br>coverage-scout<br>failure-triage-specialist<br>unit-test-runner<br>determinism-scout<br>plan-registration-auditor<br>mcp-validation-auditor<br>helping-gap-resolution-coordinator | green-validation-gates<br>coverage-guard<br>plan-sync-validation |
| 06-documenting | 1 | qwen3.5:cloud | docs-scout<br>academic-docs-auditor<br>docs-example-writer<br>plan-scout<br>license-attribution-auditor<br>vscode-ai-extensibility-scout<br>helping-gap-resolution-coordinator | educational-docs<br>docs-academic-citation-audit<br>license-attribution-audit |
| 07-logging | 1 | qwen3.5:cloud | plan-scout<br>plan-registration-auditor<br>learning-event-capturer<br>file-change-summarizer<br>helping-gap-resolution-coordinator | tracker-handoff<br>plan-sync-validation<br>capturing-learning-event |
| academic-docs-auditor | 3 | qwen3.5:cloud | - | docs-academic-citation-audit |
| acceptance-criteria-writer | 4 | qwen3.5:cloud | - | planning-acceptance-criteria |
| agent-frontmatter-auditor | 3 | qwen3.5:cloud | - | agent-frontmatter-standards |
| boundary-mapper | 3 | qwen3.5:cloud | - | solid-split |
| browser-runtime-scout | 3 | qwen3.5:cloud | - | browser-build |
| checkpoint-scout | 3 | qwen3.5:cloud | - | checkpointing-persistence |
| cortex-embeddings-scout | 3 | qwen3.5:cloud | - | - |
| coverage-guard | 3 | qwen3.5:cloud | - | coverage-guard |
| coverage-scout | 3 | qwen3.5:cloud | - | coverage-tranche |
| determinism-scout | 3 | qwen3.5:cloud | - | reproducibility-contracts |
| docs-example-writer | 4 | qwen3.5:cloud | - | - |
| docs-scout | 3 | qwen3.5:cloud | - | educational-docs |
| evaluation-pool-scout | 3 | qwen3.5:cloud | - | multithread-evaluation |
| failure-triage-specialist | 3 | qwen3.5:cloud | - | triaging-test-failures |
| file-change-summarizer | 4 | qwen3.5:cloud | - | summarizing-session-log |
| flappy-architecture-polish | 2 | GPT-5.4 (copilot) | plan-scout | flappy-architecture-polish |
| green-test-failure-triage-coordinator | 2 | qwen3.5:cloud | coverage-guard<br>coverage-scout<br>failure-triage-specialist<br>unit-test-runner<br>plan-registration-auditor<br>mcp-validation-auditor | green-validation-gates |
...
| helping-gap-resolution-coordinator | 2 | qwen3.5:cloud | skill-inventory-auditor<br>agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>model-name-auditor<br>learning-event-capturer<br>file-change-summarizer | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>subagent-delegation-patterns |
| hybrid-interop-scout | 3 | qwen3.5:cloud | - | hybrid-training-interop |
...
| implementation-pattern-scout | 3 | qwen3.5:cloud | - | - |
| learning-event-capturer | 4 | qwen3.5:cloud | - | capturing-learning-event |
| license-attribution-auditor | 3 | qwen3.5:cloud | - | license-attribution-audit |
| mcp-runtime-scout | 3 | qwen3.5:cloud | - | mcp-local-server-workflow |
| mcp-server-architect | 3 | GPT-5.4 (copilot) | - | mcp-local-server-workflow |
| mcp-validation-auditor | 3 | qwen3.5:cloud | - | mcp-local-server-workflow |
| model-name-auditor | 3 | qwen3.5:cloud | - | model-routing-and-budget |
| neatchat-scout | 3 | qwen3.5:cloud | - | neatchat-systems |
| nge-benchmark-scout | 3 | qwen3.5:cloud | - | nge-benchmark-workflow |
| nge-core-scout | 3 | qwen3.5:cloud | - | nge-core-algorithm |
| phase-handoff-designer | 3 | qwen3.5:cloud | - | phase-handoff-workflow |
| plan-registration-auditor | 3 | qwen3.5:cloud | - | plan-sync-validation |
| plan-scout | 3 | qwen3.5:cloud | - | plan-alignment |
| planning-context-coordinator | 2 | qwen3.5:cloud | plan-scout<br>docs-scout<br>boundary-mapper | plan-alignment |
| planning-risk-coordinator | 2 | qwen3.5:cloud | plan-scout<br>determinism-scout<br>license-attribution-auditor<br>model-name-auditor | model-routing-and-budget<br>license-attribution-audit |
...
| repo-cortex-scout | 3 | qwen3.5:cloud | - | repo-cortex-workflow |
| research-codebase-coordinator | 2 | qwen3.5:cloud | plan-scout<br>docs-scout<br>repo-cortex-scout<br>boundary-mapper<br>browser-runtime-scout<br>worker-payload-scout<br>evaluation-pool-scout<br>checkpoint-scout<br>hybrid-interop-scout<br>determinism-scout<br>visualizer-scout<br>nge-core-scout<br>nge-benchmark-scout<br>neatchat-scout | subagent-delegation-patterns |
| skill-frontmatter-auditor | 3 | qwen3.5:cloud | - | skill-frontmatter-standards |
| skill-inventory-auditor | 3 | qwen3.5:cloud | - | agent-inventory-audit |
| skill-output-eval-grader | 3 | qwen3.5:cloud | - | skill-output-evals |
| skill-trigger-eval-designer | 3 | qwen3.5:cloud | - | skill-description-evals |
| solid-split | 2 | GPT-5.4 (copilot) | boundary-mapper<br>plan-scout<br>docs-scout | solid-split |
| unit-test-runner | 3 | qwen3.5:cloud | - | running-unit-tests |
| unit-test-writer | 3 | GPT-5.4 (copilot) | - | creating-unit-tests |
| visualizer-scout | 3 | qwen3.5:cloud | - | visualizer-workflow |
| vscode-ai-extensibility-scout | 3 | qwen3.5:cloud | - | - |
| worker-payload-scout | 3 | qwen3.5:cloud | - | worker-inference-transport |
...
| implementation-standards | skill | - | - | self |
...
| research-methodology | skill | - | - | self |
