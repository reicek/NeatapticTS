...
<!-- source-hash: fd4d3b94a005632937fa211f9d5fe78700f95e01a7083a0b7e272b620a2bd2d3 -->
<!-- source-file-count: 130 -->
...
| browser-runtime-scout | 3 | moderate | kimi-k2.7-code:cloud | - | browser-build |
| browser-ui-specialist | 3 | moderate | kimi-k2.7-code:cloud | - | chrome-devtools-mcp |
| checkpoint-scout | 3 | moderate | kimi-k2.7-code:cloud | - | checkpointing-persistence |
| code-quality-auditor | 3 | moderate | kimi-k2.7-code:cloud | file-change-summarizer | green-validation-gates<br>implementation-standards |
| cortex-embeddings-scout | 3 | moderate | kimi-k2.7-code:cloud | - | repo-cortex-embeddings |
| coverage-guard | 3 | moderate | kimi-k2.7-code:cloud | - | coverage-guard |
| coverage-scout | 3 | moderate | kimi-k2.7-code:cloud | - | coverage-tranche<br>coverage-guard |
| determinism-scout | 3 | moderate | kimi-k2.7-code:cloud | - | reproducibility-contracts |
| docs-example-writer | 4 | moderate | kimi-k2.7-code:cloud | - | educational-docs |
| docs-scout | 3 | moderate | kimi-k2.7-code:cloud | - | educational-docs |
| evaluation-pool-scout | 3 | moderate | kimi-k2.7-code:cloud | - | multithread-evaluation |
| failure-triage-specialist | 3 | moderate | kimi-k2.7-code:cloud | - | triaging-test-failures<br>test-fix-workflow |
| file-change-summarizer | 4 | moderate | kimi-k2.7-code:cloud | - | summarizing-session-log |
| flappy-architecture-polish | 2 | moderate | kimi-k2.7-code:cloud | plan-scout | flappy-architecture-polish<br>architecture-builder<br>performance-optimization<br>execute |
| green-test-failure-triage-coordinator | 2 | moderate | kimi-k2.7-code:cloud | coverage-guard<br>coverage-scout<br>code-quality-auditor<br>failure-triage-specialist<br>unit-test-runner<br>plan-registration-auditor<br>mcp-validation-auditor | green-validation-gates<br>test-fix-workflow<br>execute |
| helping-agent-maintenance-coordinator | 2 | moderate | kimi-k2.7-code:cloud | agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>skill-inventory-auditor<br>model-name-auditor<br>learning-event-capturer | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>agent-json-body-to-md<br>agent-script-tooling<br>creating-specialist-agent<br>splitting-monolithic-agent<br>execute |
| helping-gap-resolution-coordinator | 2 | moderate | kimi-k2.7-code:cloud | skill-inventory-auditor<br>agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>mcp-runtime-scout<br>model-name-auditor<br>learning-event-capturer<br>file-change-summarizer | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>creating-specialist-agent<br>subagent-delegation-patterns<br>execute |
| hybrid-interop-scout | 3 | moderate | kimi-k2.7-code:cloud | - | hybrid-training-interop |
| implementation-executor | 2 | moderate | kimi-k2.7-code:cloud | boundary-mapper<br>docs-scout<br>browser-runtime-scout<br>worker-payload-scout<br>checkpoint-scout<br>determinism-scout | implementation-standards<br>coverage-guard<br>execute |
| implementation-pattern-coordinator | 2 | moderate | kimi-k2.7-code:cloud | implementation-pattern-scout<br>boundary-mapper<br>docs-scout<br>agent-frontmatter-auditor | subagent-delegation-patterns<br>implementation-standards<br>execute |
...
| license-attribution-auditor | 3 | moderate | kimi-k2.7-code:cloud | - | license-attribution-audit |
| mcp-runtime-scout | 3 | moderate | kimi-k2.7-code:cloud | - | mcp-local-server-workflow |
| mcp-server-architect | 3 | moderate | kimi-k2.7-code:cloud | - | mcp-local-server-workflow |
| mcp-validation-auditor | 3 | moderate | kimi-k2.7-code:cloud | - | mcp-local-server-workflow |
| model-name-auditor | 3 | moderate | kimi-k2.7-code:cloud | - | model-routing-and-budget |
| neatchat-scout | 3 | moderate | kimi-k2.7-code:cloud | - | neatchat-systems |
| nge-benchmark-scout | 3 | moderate | kimi-k2.7-code:cloud | - | nge-benchmark-workflow |
| nge-core-scout | 3 | moderate | kimi-k2.7-code:cloud | - | nge-core-algorithm |
...
| phase-handoff-designer | 3 | moderate | kimi-k2.7-code:cloud | - | phase-handoff-workflow |
| plan-registration-auditor | 3 | moderate | kimi-k2.7-code:cloud | - | plan-sync-validation |
| plan-scout | 3 | moderate | kimi-k2.7-code:cloud | - | plan-alignment |
| planning-context-coordinator | 2 | moderate | kimi-k2.7-code:cloud | plan-scout<br>docs-scout<br>boundary-mapper | plan-alignment<br>execute |
| planning-risk-coordinator | 2 | moderate | kimi-k2.7-code:cloud | plan-scout<br>boundary-mapper<br>implementation-pattern-scout<br>determinism-scout<br>license-attribution-auditor<br>model-name-auditor | model-routing-and-budget<br>license-attribution-audit<br>planning-acceptance-criteria<br>execute |
| planning-test-strategy-coordinator | 2 | moderate | kimi-k2.7-code:cloud | coverage-scout<br>test-coverage-analyst<br>determinism-scout<br>acceptance-criteria-writer<br>unit-test-writer | planning-acceptance-criteria<br>red-test-contracts<br>execute |
| repo-cortex-scout | 3 | moderate | kimi-k2.7-code:cloud | - | repo-cortex-workflow |
| research-codebase-coordinator | 2 | moderate | kimi-k2.7-code:cloud | plan-scout<br>docs-scout<br>repo-cortex-scout<br>boundary-mapper<br>implementation-pattern-scout<br>browser-runtime-scout<br>worker-payload-scout<br>evaluation-pool-scout<br>checkpoint-scout<br>hybrid-interop-scout<br>determinism-scout<br>visualizer-scout<br>nge-core-scout<br>nge-benchmark-scout<br>neatchat-scout<br>research-synthesis-specialist | subagent-delegation-patterns<br>repo-cortex-workflow<br>research-methodology<br>execute |
| research-synthesis-specialist | 3 | moderate | kimi-k2.7-code:cloud | acceptance-criteria-writer<br>file-change-summarizer | research-methodology<br>plan-alignment |
| skill-frontmatter-auditor | 3 | moderate | kimi-k2.7-code:cloud | - | skill-frontmatter-standards<br>updating-skill-frontmatter |
| skill-inventory-auditor | 3 | moderate | kimi-k2.7-code:cloud | - | agent-inventory-audit |
| skill-output-eval-grader | 3 | moderate | kimi-k2.7-code:cloud | - | skill-output-evals |
| skill-trigger-eval-designer | 3 | moderate | kimi-k2.7-code:cloud | - | skill-description-evals |
| slice-orchestration-scheduler | 3 | moderate | kimi-k2.7-code:cloud | - | subagent-delegation-patterns<br>phase-handoff-workflow<br>tracker-handoff<br>execute |
...
| test-coverage-analyst | 3 | moderate | kimi-k2.7-code:cloud | - | coverage-guard<br>coverage-tranche |
| unit-test-runner | 3 | moderate | kimi-k2.7-code:cloud | - | running-unit-tests |
| unit-test-writer | 3 | moderate | kimi-k2.7-code:cloud | - | creating-unit-tests<br>red-test-contracts |
| visualizer-scout | 3 | moderate | kimi-k2.7-code:cloud | - | visualizer-workflow |
| vscode-ai-extensibility-scout | 3 | moderate | kimi-k2.7-code:cloud | - | mcp-local-server-workflow |
| webgpu-scout | 3 | moderate | glm-5.2:cloud (ollama) | - | webgpu |
| worker-payload-scout | 3 | moderate | kimi-k2.7-code:cloud | - | worker-inference-transport |
...
| research-methodology | skill | - | 01-planning<br>02-researching<br>03-red-testing<br>04-implementing<br>05-green-testing<br>06-documenting<br>07-logging<br>acceptance-criteria-writer<br>browser-harness-specialist<br>research-codebase-coordinator<br>research-synthesis-specialist | self |
...
| webgpu | skill | - | webgpu-scout | self |
