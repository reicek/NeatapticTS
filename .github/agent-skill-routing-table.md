...
<!-- source-hash: 6a54746aecaac4fbbe21c5db859e5df8e85bb68b8d8ed9b42cec276d9d4a0e12 -->
...
| --- | --- | --- | --- | --- |
| 00-helping | 1 | - | helping-gap-resolution-coordinator<br>helping-agent-maintenance-coordinator<br>skill-inventory-auditor<br>agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>model-name-auditor<br>skill-trigger-eval-designer<br>skill-output-eval-grader<br>coverage-guard<br>learning-event-capturer<br>file-change-summarizer<br>slice-orchestration-scheduler | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>customize-cloud-agent<br>subagent-delegation-patterns<br>capturing-learning-event<br>routing-optimization-policy<br>phase-handoff-workflow<br>tracker-handoff<br>execute |
| 01-planning | 1 | - | planning-context-coordinator<br>planning-risk-coordinator<br>planning-test-strategy-coordinator<br>acceptance-criteria-writer<br>plan-scout<br>model-name-auditor<br>plan-registration-auditor<br>helping-gap-resolution-coordinator<br>research-synthesis-specialist<br>phase-handoff-designer | plan-alignment<br>tracker-handoff<br>phase-handoff-workflow<br>agent-frontmatter-standards<br>model-routing-and-budget<br>license-attribution-audit<br>planning-acceptance-criteria<br>plan-sync-validation<br>research-methodology<br>execute |
| 02-researching | 1 | - | research-codebase-coordinator<br>plan-scout<br>docs-scout<br>repo-cortex-scout<br>boundary-mapper<br>skill-inventory-auditor<br>helping-gap-resolution-coordinator<br>cortex-embeddings-scout | subagent-delegation-patterns<br>research-methodology<br>repo-cortex-workflow<br>execute |
| 03-red-testing | 1 | - | planning-test-strategy-coordinator<br>acceptance-criteria-writer<br>unit-test-writer<br>test-coverage-analyst<br>coverage-scout<br>determinism-scout<br>plan-scout<br>helping-gap-resolution-coordinator<br>performance-trace-specialist<br>browser-ui-specialist<br>browser-memory-specialist | red-test-contracts<br>creating-unit-tests<br>test-fix-workflow<br>coverage-tranche<br>research-methodology<br>execute<br>chrome-devtools-mcp |
| 04-implementing | 1 | - | implementation-pattern-coordinator<br>implementation-pattern-scout<br>implementation-executor<br>boundary-mapper<br>docs-scout<br>browser-runtime-scout<br>worker-payload-scout<br>evaluation-pool-scout<br>checkpoint-scout<br>hybrid-interop-scout<br>determinism-scout<br>visualizer-scout<br>nge-core-scout<br>nge-benchmark-scout<br>neatchat-scout<br>solid-split<br>flappy-architecture-polish<br>agent-frontmatter-auditor<br>phase-handoff-designer<br>mcp-server-architect<br>helping-gap-resolution-coordinator | implementation-standards<br>coverage-guard<br>tracker-handoff<br>architecture-builder<br>onnx-work<br>performance-optimization<br>trace-analyzer-extension<br>worker-inference-transport<br>research-methodology<br>execute |
| 05-green-testing | 1 | - | green-test-failure-triage-coordinator<br>coverage-guard<br>coverage-scout<br>failure-triage-specialist<br>unit-test-runner<br>determinism-scout<br>plan-registration-auditor<br>mcp-validation-auditor<br>helping-gap-resolution-coordinator<br>code-quality-auditor<br>test-coverage-analyst<br>performance-trace-specialist<br>browser-ui-specialist<br>browser-memory-specialist | green-validation-gates<br>coverage-guard<br>test-fix-workflow<br>plan-sync-validation<br>trace-audit-reporting<br>research-methodology<br>execute<br>chrome-devtools-mcp |
| 06-documenting | 1 | - | docs-scout<br>academic-docs-auditor<br>docs-example-writer<br>plan-scout<br>license-attribution-auditor<br>vscode-ai-extensibility-scout<br>helping-gap-resolution-coordinator | educational-docs<br>docs-academic-citation-audit<br>license-attribution-audit<br>auditing-js-docs<br>updating-js-docs<br>research-methodology<br>execute |
| 07-logging | 1 | - | plan-scout<br>plan-registration-auditor<br>learning-event-capturer<br>file-change-summarizer<br>helping-gap-resolution-coordinator<br>phase-handoff-designer | tracker-handoff<br>summarizing-session-log<br>plan-sync-validation<br>capturing-learning-event<br>research-methodology<br>execute |
| academic-docs-auditor | 3 | - | - | docs-academic-citation-audit<br>auditing-js-docs |
| acceptance-criteria-writer | 4 | - | - | planning-acceptance-criteria |
| agent-frontmatter-auditor | 3 | - | - | agent-frontmatter-standards<br>updating-agent-frontmatter |
| boundary-mapper | 3 | - | - | solid-split<br>implementation-standards |
| browser-memory-specialist | 3 | - | - | chrome-devtools-mcp |
| browser-runtime-scout | 3 | - | - | browser-build |
| browser-ui-specialist | 3 | - | - | chrome-devtools-mcp |
| checkpoint-scout | 3 | - | - | checkpointing-persistence |
| code-quality-auditor | 3 | - | file-change-summarizer | green-validation-gates<br>implementation-standards |
| cortex-embeddings-scout | 3 | - | - | repo-cortex-embeddings |
| coverage-guard | 3 | - | - | coverage-guard |
| coverage-scout | 3 | - | - | coverage-tranche<br>coverage-guard |
| determinism-scout | 3 | - | - | reproducibility-contracts |
| docs-example-writer | 4 | - | - | educational-docs |
| docs-scout | 3 | - | - | educational-docs |
| evaluation-pool-scout | 3 | - | - | multithread-evaluation |
| failure-triage-specialist | 3 | - | - | triaging-test-failures<br>test-fix-workflow |
| file-change-summarizer | 4 | - | - | summarizing-session-log |
| flappy-architecture-polish | 2 | - | plan-scout | flappy-architecture-polish<br>architecture-builder<br>performance-optimization<br>execute |
| green-test-failure-triage-coordinator | 2 | - | coverage-guard<br>coverage-scout<br>code-quality-auditor<br>failure-triage-specialist<br>unit-test-runner<br>plan-registration-auditor<br>mcp-validation-auditor | green-validation-gates<br>test-fix-workflow<br>execute |
| helping-agent-maintenance-coordinator | 2 | - | agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>skill-inventory-auditor<br>model-name-auditor<br>learning-event-capturer | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>agent-json-body-to-md<br>agent-script-tooling<br>creating-specialist-agent<br>splitting-monolithic-agent<br>execute |
| helping-gap-resolution-coordinator | 2 | - | skill-inventory-auditor<br>agent-frontmatter-auditor<br>skill-frontmatter-auditor<br>mcp-runtime-scout<br>model-name-auditor<br>learning-event-capturer<br>file-change-summarizer | agent-frontmatter-standards<br>model-routing-and-budget<br>agent-inventory-audit<br>creating-specialist-agent<br>subagent-delegation-patterns<br>execute |
| hybrid-interop-scout | 3 | - | - | hybrid-training-interop |
| implementation-executor | 2 | - | boundary-mapper<br>docs-scout<br>browser-runtime-scout<br>worker-payload-scout<br>checkpoint-scout<br>determinism-scout | implementation-standards<br>coverage-guard<br>execute |
| implementation-pattern-coordinator | 2 | - | implementation-pattern-scout<br>boundary-mapper<br>docs-scout<br>agent-frontmatter-auditor | subagent-delegation-patterns<br>implementation-standards<br>execute |
| implementation-pattern-scout | 3 | - | - | implementation-standards |
| learning-event-capturer | 4 | - | - | capturing-learning-event |
| license-attribution-auditor | 3 | - | - | license-attribution-audit |
| mcp-runtime-scout | 3 | - | - | mcp-local-server-workflow |
| mcp-server-architect | 3 | - | - | mcp-local-server-workflow |
| mcp-validation-auditor | 3 | - | - | mcp-local-server-workflow |
| model-name-auditor | 3 | - | - | model-routing-and-budget |
| neatchat-scout | 3 | - | - | neatchat-systems |
| nge-benchmark-scout | 3 | - | - | nge-benchmark-workflow |
| nge-core-scout | 3 | - | - | nge-core-algorithm |
| performance-trace-specialist | 3 | - | - | chrome-devtools-mcp<br>trace-audit-reporting<br>trace-analyzer-extension |
| phase-handoff-designer | 3 | - | - | phase-handoff-workflow |
| plan-registration-auditor | 3 | - | - | plan-sync-validation |
| plan-scout | 3 | - | - | plan-alignment |
| planning-context-coordinator | 2 | - | plan-scout<br>docs-scout<br>boundary-mapper | plan-alignment<br>execute |
| planning-risk-coordinator | 2 | - | plan-scout<br>boundary-mapper<br>implementation-pattern-scout<br>determinism-scout<br>license-attribution-auditor<br>model-name-auditor | model-routing-and-budget<br>license-attribution-audit<br>planning-acceptance-criteria<br>execute |
| planning-test-strategy-coordinator | 2 | - | coverage-scout<br>test-coverage-analyst<br>determinism-scout<br>acceptance-criteria-writer<br>unit-test-writer | planning-acceptance-criteria<br>red-test-contracts<br>execute |
| repo-cortex-scout | 3 | - | - | repo-cortex-workflow |
| research-codebase-coordinator | 2 | - | plan-scout<br>docs-scout<br>repo-cortex-scout<br>boundary-mapper<br>implementation-pattern-scout<br>browser-runtime-scout<br>worker-payload-scout<br>evaluation-pool-scout<br>checkpoint-scout<br>hybrid-interop-scout<br>determinism-scout<br>visualizer-scout<br>nge-core-scout<br>nge-benchmark-scout<br>neatchat-scout<br>research-synthesis-specialist | subagent-delegation-patterns<br>repo-cortex-workflow<br>research-methodology<br>execute |
| research-synthesis-specialist | 3 | - | acceptance-criteria-writer<br>file-change-summarizer | research-methodology<br>plan-alignment |
| skill-frontmatter-auditor | 3 | - | - | skill-frontmatter-standards<br>updating-skill-frontmatter |
| skill-inventory-auditor | 3 | - | - | agent-inventory-audit |
| skill-output-eval-grader | 3 | - | - | skill-output-evals |
| skill-trigger-eval-designer | 3 | - | - | skill-description-evals |
| slice-orchestration-scheduler | 3 | - | - | subagent-delegation-patterns<br>phase-handoff-workflow<br>tracker-handoff<br>execute |
| solid-split | 2 | - | boundary-mapper<br>plan-scout<br>docs-scout | solid-split<br>implementation-standards<br>execute |
| test-coverage-analyst | 3 | - | - | coverage-guard<br>coverage-tranche |
| unit-test-runner | 3 | - | - | running-unit-tests |
| unit-test-writer | 3 | - | - | creating-unit-tests<br>red-test-contracts |
| visualizer-scout | 3 | - | - | visualizer-workflow |
| vscode-ai-extensibility-scout | 3 | - | - | mcp-local-server-workflow |
| worker-payload-scout | 3 | - | - | worker-inference-transport |
